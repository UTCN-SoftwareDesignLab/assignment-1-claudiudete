...
public class Constants {
    ...
    public static class Rights {
        ...
        public static final String[] RIGHTS = new String[]{CREATE_USER, DELETE_USER, UPDATE_USER,
                GENERATE_REPORT,VIEW_USER,CREATE_ACCOUNT,DELETE_ACCOUNT,UPDATE_ACCOUNT,VIEW_ACCOUNT,TRANSFER,CREATE_CLIENT,DELETE_CLIENT,UPDATE_CLIENT};
    }
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(EMPLOYEE).addAll(Arrays.asList(CREATE_CLIENT, DELETE_CLIENT, UPDATE_CLIENT, CREATE_ACCOUNT, DELETE_ACCOUNT, UPDATE_ACCOUNT, VIEW_ACCOUNT, TRANSFER));
